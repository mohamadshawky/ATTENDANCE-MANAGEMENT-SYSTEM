...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(221, 71);
			...
			this->label2->Location = System::Drawing::Point(221, 100);
			...
			this->button1->Location = System::Drawing::Point(249, 171);
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(343, 64);
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(343, 100);
...
#pragma endregion
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
			 ...
			 if(textBox1->Text=="developer" &&textBox2->Text=="bfci")
			 {
			 Home^ frm = gcnew Home();
			 frm->ShowDialog();
			 this->Hide();
				...
				{MessageBox::Show("The username or password may be incorrect , Try Again" , "Error" , MessageBoxButtons::OK ,MessageBoxIcon::Error);
				textBox1->Text="";
				textBox2->Text="";}
...
private: System::Void Form1_Load(System::Object^  sender, System::EventArgs^  e) {
			 MessageBox::Show("Attendance system is a technique which rules the attendance and absence process for employees at governmental agencies and students at educational institutes , The purpose of the project is to build an application program to reduce manual work as it saves efforts and makes organizations more manageable . It is accessed only by the administrator !", "Attendance System" , MessageBoxButtons::OK ,MessageBoxIcon::Question);
		 }
};
}
